...
namespace RoleData {
    ...
    static RoleInfoReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "aXN0GAIgAygLMhUuUm9sZURhdGEuT25lQ2hhdERhdGEiqQMKDFByb3BlcnR5",
            ...
            "GAMgASgCIr8GCg9QZW9wbGVQcm90b0RhdGESDgoGb25seUlkGAEgASgEEiwK",
            ...
            "KAUSDAoEbmFtZRgGIAEoCRIQCghhY3Rpb25JZBgHIAEoBRIbChNmaW5pc2hJ",
            "bnZpdGVQcm9jZXNzGAggASgIEjQKEW1lSW52aXRlT3RoZXJMaXN0GAkgAygL",
            "MhkuUm9sZURhdGEuUGVvcGxlUHJvdG9EYXRhEjQKEW90aGVySW52aXRlTWVM",
            "aXN0GAogAygLMhkuUm9sZURhdGEuUGVvcGxlUHJvdG9EYXRhEhIKCnJlY29y",
            "ZExpc3QYCyADKAkSLgoLY2hhdEZyaWVuZHMYDCADKAsyGS5Sb2xlRGF0YS5Q",
            "ZW9wbGVQcm90b0RhdGESEAoIaXNQbGF5ZXIYDSABKAgSFwoPY2hvb3NlZEFj",
            "dGlvbklkGA4gASgFEkMKG0FsbFNpbmdsZVBlb3BsZUNoYXREYXRhTGlzdBgP",
            "IAMoCzIeLlJvbGVEYXRhLlNpbmdsZVBlb3BsZUNoYXREYXRhEhcKD3ZhbGlk",
            "V2l0aFBlb3BsZRgQIAMoBBIcChRwbGF5ZXJWb2NhbFJlZnVzZWRNZRgRIAEo",
            "CBIZChFjdXJQbGFuV2l0aFBlb3BsZRgSIAEoBBIZChFleGFtQmF0dGxlX2N1",
            "ckV4cBgTIAEoBRIbChNleGFtQmF0dGxlX2N1ckxldmVsGBQgASgFEioKC2Fj",
            "aGlldmVtZW50GBUgASgLMhUuUm9sZURhdGEuQWNoaWV2ZW1lbnQSGgoSYmVB",
            "dHRyYWN0UGFyYW1MaXN0GBYgAygFEh8KF3NvY2lhbGl6YXRpb25QcmVmZXJl",
            "bmNlGBcgASgFEhkKEWFkZFdlQ2hhdEludGVyZXN0GBggASgFEiUKHWNvbnRh",
            "Y3RlZFBlb3BsZUluU2luZ2xlQWN0aW9uGBkgAygEIm8KDVBsYW5Qcm90b0Rh",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, new pbr::GeneratedClrTypeInfo[] {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::RoleData.PeopleProtoData), global::RoleData.PeopleProtoData.Parser, new[]{ "OnlyId", "PropertyData", "SensedOtherPeopleIdList", "FriendlinessToSensedOtherPeopleList", "Gender", "Name", "ActionId", "FinishInviteProcess", "MeInviteOtherList", "OtherInviteMeList", "RecordList", "ChatFriends", "IsPlayer", "ChoosedActionId", "AllSinglePeopleChatDataList", "ValidWithPeople", "PlayerVocalRefusedMe", "CurPlanWithPeople", "ExamBattleCurExp", "ExamBattleCurLevel", "Achievement", "BeAttractParamList", "SocializationPreference", "AddWeChatInterest", "ContactedPeopleInSingleAction" }, null, null, null),
  ...
  public sealed partial class PropertyData : pb::IMessage<PropertyData> {
    ...
    public PropertyData(PropertyData other) : this() {
      ...
      curArtExp_ = other.curArtExp_;
      curPhysicalExp_ = other.curPhysicalExp_;
      _unknownFields = pb::UnknownFieldSet.Clone(other._unknownFields);
    }
    ...
    /// <summary>Field number for the "curArtExp" field.</summary>
    public const int CurArtExpFieldNumber = 13;
    private int curArtExp_;
    /// <summary>
    ///当前艺术经验
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public int CurArtExp {
      get { return curArtExp_; }
      set {
        curArtExp_ = value;
      }
    }

    /// <summary>Field number for the "curPhysicalExp" field.</summary>
    public const int CurPhysicalExpFieldNumber = 14;
    private int curPhysicalExp_;
    /// <summary>
    ///当前体育经验
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public int CurPhysicalExp {
      get { return curPhysicalExp_; }
      set {
        curPhysicalExp_ = value;
      }
    }
    ...
    public bool Equals(PropertyData other) {
      ...
      if (CurArtExp != other.CurArtExp) return false;
      if (CurPhysicalExp != other.CurPhysicalExp) return false;
      return Equals(_unknownFields, other._unknownFields);
    }
    ...
    public override int GetHashCode() {
      ...
      if (CurArtExp != 0) hash ^= CurArtExp.GetHashCode();
      if (CurPhysicalExp != 0) hash ^= CurPhysicalExp.GetHashCode();
      if (_unknownFields != null) {
        hash ^= _unknownFields.GetHashCode();
      }
      return hash;
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (CurArtExp != 0) {
        ...
        output.WriteInt32(CurArtExp);
      }
      if (CurPhysicalExp != 0) {
        output.WriteRawTag(112);
        output.WriteInt32(CurPhysicalExp);
      }
      if (_unknownFields != null) {
        _unknownFields.WriteTo(output);
      }
    ...
    public int CalculateSize() {
      ...
      if (CurArtExp != 0) {
        size += 1 + pb::CodedOutputStream.ComputeInt32Size(CurArtExp);
      }
      if (CurPhysicalExp != 0) {
        size += 1 + pb::CodedOutputStream.ComputeInt32Size(CurPhysicalExp);
      }
      if (_unknownFields != null) {
        size += _unknownFields.CalculateSize();
      }
    ...
    public void MergeFrom(PropertyData other) {
      ...
      if (other.CurArtExp != 0) {
        CurArtExp = other.CurArtExp;
      }
      if (other.CurPhysicalExp != 0) {
        CurPhysicalExp = other.CurPhysicalExp;
      }
      _unknownFields = pb::UnknownFieldSet.MergeFrom(_unknownFields, other._unknownFields);
    }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 104: {
            CurArtExp = input.ReadInt32();
            break;
          }
          case 112: {
            CurPhysicalExp = input.ReadInt32();
            break;
          }
        }
      }
  ...
  public sealed partial class PeopleProtoData : pb::IMessage<PeopleProtoData> {
    ...
    public PeopleProtoData(PeopleProtoData other) : this() {
      ...
      beAttractParamList_ = other.beAttractParamList_.Clone();
      socializationPreference_ = other.socializationPreference_;
    ...
    private static readonly pb::FieldCodec<float> _repeated_friendlinessToSensedOtherPeopleList_codec
        = pb::FieldCodec.ForFloat(34);
    private readonly pbc::RepeatedField<float> friendlinessToSensedOtherPeopleList_ = new pbc::RepeatedField<float>();
    /// <summary>
    ///对感受到的人的好感度
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::RepeatedField<float> FriendlinessToSensedOtherPeopleList {
    ...
    /// <summary>Field number for the "beAttractParamList" field.</summary>
    public const int BeAttractParamListFieldNumber = 22;
    private static readonly pb::FieldCodec<int> _repeated_beAttractParamList_codec
        = pb::FieldCodec.ForInt32(178);
    private readonly pbc::RepeatedField<int> beAttractParamList_ = new pbc::RepeatedField<int>();
    /// <summary>
    ///容易被什么人吸引0学习1艺术2体育
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::RepeatedField<int> BeAttractParamList {
      get { return beAttractParamList_; }
    }

    /// <summary>Field number for the "socializationPreference" field.</summary>
    public const int SocializationPreferenceFieldNumber = 23;
    private int socializationPreference_;
    /// <summary>
    ///社交倾向 百分制 越高越喜欢社交（可后续提高
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public int SocializationPreference {
      get { return socializationPreference_; }
      set {
        socializationPreference_ = value;
      }
    }

    /// <summary>Field number for the "addWeChatInterest" field.</summary>
    public const int AddWeChatInterestFieldNumber = 24;
    private int addWeChatInterest_;
    /// <summary>
    ///多少好感可以解锁微信
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public int AddWeChatInterest {
      get { return addWeChatInterest_; }
      set {
        addWeChatInterest_ = value;
      }
    }

    /// <summary>Field number for the "contactedPeopleInSingleAction" field.</summary>
    public const int ContactedPeopleInSingleActionFieldNumber = 25;
    private static readonly pb::FieldCodec<ulong> _repeated_contactedPeopleInSingleAction_codec
        = pb::FieldCodec.ForUInt64(202);
    private readonly pbc::RepeatedField<ulong> contactedPeopleInSingleAction_ = new pbc::RepeatedField<ulong>();
    /// <summary>
    ///在单次活动中有过社交的人
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::RepeatedField<ulong> ContactedPeopleInSingleAction {
      get { return contactedPeopleInSingleAction_; }
    }
    ...
    public bool Equals(PeopleProtoData other) {
      ...
      if(!beAttractParamList_.Equals(other.beAttractParamList_)) return false;
      if (SocializationPreference != other.SocializationPreference) return false;
    ...
    public override int GetHashCode() {
      ...
      hash ^= beAttractParamList_.GetHashCode();
      if (SocializationPreference != 0) hash ^= SocializationPreference.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      beAttractParamList_.WriteTo(output, _repeated_beAttractParamList_codec);
      if (SocializationPreference != 0) {
        output.WriteRawTag(184, 1);
        output.WriteInt32(SocializationPreference);
      }
      if (AddWeChatInterest != 0) {
        output.WriteRawTag(192, 1);
        output.WriteInt32(AddWeChatInterest);
      }
    ...
    public int CalculateSize() {
      ...
      size += beAttractParamList_.CalculateSize(_repeated_beAttractParamList_codec);
      if (SocializationPreference != 0) {
        size += 2 + pb::CodedOutputStream.ComputeInt32Size(SocializationPreference);
      }
      if (AddWeChatInterest != 0) {
        size += 2 + pb::CodedOutputStream.ComputeInt32Size(AddWeChatInterest);
      }
    ...
    public void MergeFrom(PeopleProtoData other) {
      ...
      beAttractParamList_.Add(other.beAttractParamList_);
      if (other.SocializationPreference != 0) {
        SocializationPreference = other.SocializationPreference;
      }
      if (other.AddWeChatInterest != 0) {
        AddWeChatInterest = other.AddWeChatInterest;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 178:
          case 176: {
            beAttractParamList_.AddEntriesFrom(input, _repeated_beAttractParamList_codec);
            break;
          }
          case 184: {
            SocializationPreference = input.ReadInt32();
            break;
          }
          case 192: {
            AddWeChatInterest = input.ReadInt32();
            break;
          }
          case 202:
          case 200: {
            contactedPeopleInSingleAction_.AddEntriesFrom(input, _repeated_contactedPeopleInSingleAction_codec);
            break;
          }
        }
      }
